...
import com.malaxiaoyugan.test.common.PayEnum;
...
import com.malaxiaoyugan.test.pay.service.PayOrderService;
import com.malaxiaoyugan.test.utils.MyBase64;
import com.malaxiaoyugan.test.utils.PayUtil;
import com.malaxiaoyugan.test.wxPay.wechat.WxPayProperties;
import com.malaxiaoyugan.test.wxPay.wechat.WxPayUtil;
...
public class PayChannel4WxController{
    ...
    public String doWxPayReq(@RequestParam String jsonParam) {
        try{
            ...
            if("".equals(resKey)) return PayUtil.makeRetFail(PayUtil.makeRetMap(PayConstant.RETURN_VALUE_FAIL, "", PayConstant.RETURN_VALUE_FAIL, PayEnum.ERR_0001));
            ...
            return PayUtil.makeRetFail(PayUtil.makeRetMap(PayConstant.RETURN_VALUE_FAIL, "", PayConstant.RETURN_VALUE_FAIL, PayEnum.ERR_0001));
        }
    }
