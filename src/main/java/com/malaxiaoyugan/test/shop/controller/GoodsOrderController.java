package com.malaxiaoyugan.test.shop.controller;

import com.alibaba.fastjson.JSON;
import com.alibaba.fastjson.JSONObject;
import com.malaxiaoyugan.test.common.PayConstant;
import com.malaxiaoyugan.test.shop.dao.model.GoodsOrder;
import com.malaxiaoyugan.test.shop.service.GoodsOrderService;
import com.malaxiaoyugan.test.shop.util.Constant;
import com.malaxiaoyugan.test.shop.util.DateUtil;
import com.malaxiaoyugan.test.shop.util.OAuth2RequestParamHelper;
import com.malaxiaoyugan.test.shop.util.vx.WxApi;
import com.malaxiaoyugan.test.shop.util.vx.WxApiClient;
import com.malaxiaoyugan.test.utils.AmountUtil;
...
public class GoodsOrderController {
    ...
    public void payNotify(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        try {
            ...
            resStr = "fail";
            log.error(e+ "执行业务异常,payOrderId=%s.mchOrderNo=%s", payOrderId, mchOrderNo);
        }
    ...
    void outResult(HttpServletResponse response, String content) {
        ...
        try {
            ...
            log.error(e+ "response xxpay write exception.");
        }
    }
